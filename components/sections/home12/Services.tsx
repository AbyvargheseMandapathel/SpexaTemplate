...
export default function Services() {
	return (
		<>
			<section className="position-relative overflow-hidden box-our-services-6" style={{
				backgroundImage: 'url(/_next/static/media/bg-footer-2.eda2c9e8.png), linear-gradient(to right, #001b2b, #00253a)',
				...
				<div className="position-absolute" style={{ top: '30%', right: '15%', width: '100px', height: '100px', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '50%' }}></div>
