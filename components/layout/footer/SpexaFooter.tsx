              ...
              <div className="top-footer-right">
                <div className="form-newsletter">
                  <form action="#">
                    ...
                    <button type="submit" className="btn btn-blue-newsletter" aria-label="Submit">
                      {/* Submit icon or empty button */}
                    </button>
                  </form>
                </div>
              </div>
                  ...
                  <p className="text-inline">
                    <Link href={`mailto:${contactInfo.email}`}>
                      <svg className="me-2" width={14} height={14} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.6875 1.5C13.3984 1.5 14 2.10156 14 2.8125C14 3.25 13.7812 3.63281 13.4531 3.87891L7.51953 8.33594C7.19141 8.58203 6.78125 8.58203 6.45312 8.33594L0.519531 3.87891C0.191406 3.63281 0 3.25 0 2.8125C0 2.10156 0.574219 1.5 1.3125 1.5H12.6875ZM5.93359 9.04688C6.5625 9.51172 7.41016 9.51172 8.03906 9.04688L14 4.5625V10.25C14 11.2344 13.207 12 12.25 12H1.75C0.765625 12 0 11.2344 0 10.25V4.5625L5.93359 9.04688Z" fill="white" />
                      </svg>
                      <span className="color-white-70">{contactInfo.email}</span>
                    </Link>
                  </p>
                  <p className="text-inline">
